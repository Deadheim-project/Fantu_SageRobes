...
public class Settings : MonoBehaviour
{
	...
	private void LoadSettings()
	{
		...
		m_continousMusic.isOn = ((PlayerPrefs.GetInt("ContinousMusic", 1) == 1) ? true : false);
		...
		m_cameraShake.isOn = ((PlayerPrefs.GetInt("CameraShake", 1) == 1) ? true : false);
		m_shipCameraTilt.isOn = ((PlayerPrefs.GetInt("ShipCameraTilt", 1) == 1) ? true : false);
		m_quickPieceSelect.isOn = ((PlayerPrefs.GetInt("QuickPieceSelect", 0) == 1) ? true : false);
		m_showKeyHints.isOn = ((PlayerPrefs.GetInt("KeyHints", 1) == 1) ? true : false);
		m_dofToggle.isOn = ((PlayerPrefs.GetInt("DOF", 1) == 1) ? true : false);
		m_vsyncToggle.isOn = ((PlayerPrefs.GetInt("VSync", 0) == 1) ? true : false);
		m_bloomToggle.isOn = ((PlayerPrefs.GetInt("Bloom", 1) == 1) ? true : false);
		m_ssaoToggle.isOn = ((PlayerPrefs.GetInt("SSAO", 1) == 1) ? true : false);
		m_sunshaftsToggle.isOn = ((PlayerPrefs.GetInt("SunShafts", 1) == 1) ? true : false);
		m_aaToggle.isOn = ((PlayerPrefs.GetInt("AntiAliasing", 1) == 1) ? true : false);
		m_caToggle.isOn = ((PlayerPrefs.GetInt("ChromaticAberration", 1) == 1) ? true : false);
		m_motionblurToggle.isOn = ((PlayerPrefs.GetInt("MotionBlur", 1) == 1) ? true : false);
		m_softPartToggle.isOn = ((PlayerPrefs.GetInt("SoftPart", 1) == 1) ? true : false);
		m_tesselationToggle.isOn = ((PlayerPrefs.GetInt("Tesselation", 1) == 1) ? true : false);
