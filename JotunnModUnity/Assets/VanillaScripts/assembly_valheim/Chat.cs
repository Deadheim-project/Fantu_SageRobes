...
public class Chat : Terminal
{
	...
	public override void Awake()
	{
		...
		AddString(Localization.instance.Localize("/respawn - $chat_kill"));
		...
		Terminal.m_bindList = new SyncedList(Utils.GetSaveDataPath() + "/binds.txt", "List of custom console binds ONE per line");
